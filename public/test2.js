    ...
    function init(){
        ...
        if (window.DeviceOrientationEvent) {
            ...
            window.addEventListener("deviceorientation", function(event) 
            {
                ...
                document.getElementById("doTiltLR").innerHTML = Math.round(event.beta);
                document.getElementById("doTiltFB").innerHTML = Math.round(event.gamma);
                document.getElementById("doDirection").innerHTML = Math.round(event.alpha);
            })
        }
        else {
